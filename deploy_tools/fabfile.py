...
def _setup_env():
    ...
    env.deploy_modules = fab_settings.MODULES
    env.show = ['debug']
    _setup_paths()
...
def production():
    ...
    env.hosts = fab_settings.PRODUCTION_HOST
...
def staging():
    ...
    env.hosts = fab_settings.STAGING_HOST
...
def _setup_paths():
    ...
    env.project_root = fab_settings.PROJECT_ROOT
